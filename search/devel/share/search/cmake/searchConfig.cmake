...
if("TRUE" STREQUAL "TRUE")
  set(search_SOURCE_PREFIX /home/daniel/assignment1/PAR_Assignment1/search/src/search)
  set(search_DEVEL_PREFIX /home/daniel/assignment1/PAR_Assignment1/search/devel)
  set(search_INSTALL_PREFIX "")
  set(search_PREFIX ${search_DEVEL_PREFIX})
else()
  set(search_SOURCE_PREFIX "")
  set(search_DEVEL_PREFIX "")
  set(search_INSTALL_PREFIX /home/daniel/assignment1/PAR_Assignment1/search/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'rescue <rescue@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'search' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/daniel/assignment1/PAR_Assignment1/search/src/search/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT search_NUM_DUMMY_TARGETS)
      set(search_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::search::wrapped-linker-option${search_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR search_NUM_DUMMY_TARGETS "${search_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::search::wrapped-linker-option${search_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND search_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/daniel/assignment1/PAR_Assignment1/search/devel/lib;/home/daniel/assignment1/PAR_Assignment1/search/devel/lib;/opt/ros/melodic/lib)
